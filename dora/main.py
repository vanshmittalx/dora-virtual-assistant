...
def aiProcess(command):
    ...
    model="gpt-3.5-turbo",
    messages=[
        {"role": "system", "content": "You are a virtual assistant named dora skilled in general tasks like Alexa and Google Cloud. Give short responses please"},
